            ...
            <section id="contact" className="contact-area ptb-100 bg-image">
                <div className="container">
                    <div className="section-title">
                        ...
                        <p>Please note that the Los Villas of Vista Mariposa (LVVM) correspondence policy requires a Member’s name and LVVM property address prior to communicating with individuals on Association related matters.</p>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="contact-info">
                                ...
                                <p>20315 Marible Ln. Mission Viejo, CA 92692</p>
                            </div>
                        </div>
                        ...
                        <form id="contactForm">
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <div className="form-group">
                                        <textarea placeholder="Association Address" name="address" id="address" className="form-control" rows="3" required></textarea>
                                    </div>
                                </div>
